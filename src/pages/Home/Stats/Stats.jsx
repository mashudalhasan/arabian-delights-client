    ...
    <section className="py-10 bg-white sm:py-16 lg:py-24">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
          <h4 className="text-2xl lg:text-3xl font-medium text-gray-900">
            Numbers tell the hard works they've done in last 30 years
          </h4>
        </div>
          ...
          <div className="overflow-hidden bg-white border border-gray-200 rounded-lg">
            <div className="px-4 py-6">
              <div className="flex items-start">
                <svg
                  className="flex-shrink-0 w-12 h-12 text-warning"
          ...
          <div className="overflow-hidden bg-white border border-gray-200 rounded-lg">
            <div className="px-4 py-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h4 className="text-4xl font-bold text-gray-900">280</h4>
                  <p className="mt-1.5 text-lg font-medium leading-tight text-gray-500">
                    Recipes delivered
                  </p>
                </div>
